...
到 daocloud.io -> 我的集群 -> 添加主机 -> 试用胶囊主机 申请1台临时 VPS，得到 VPS IP和密码，我这里得到的IP、用户名、密码分别是 54.223.16.47 、ubuntu 、 a3ce4babb8f293a0。
ssh 连接到 54.223.16.47。
...
更换 npm 源，命令为 npm config set registry https://registry.npm.taobao.org
...
生成 Linux 桌面版，命令为 make package-linux，得到 lantern_linux_386、lantern_linux_amd64、lantern_9.9.9_i386.deb、lantern_9.9.9_amd64.deb、lantern-manoto_9.9.9_i386.deb、lantern-manoto_9.9.9_amd64.deb。
